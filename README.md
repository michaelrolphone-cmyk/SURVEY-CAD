...
LineSmith map tiles now overzoom past native tile availability by reusing the last available zoom level (pixelated when necessary), so users can keep zooming without blank map gaps.
