...
- Stackhero MinIO keys are also supported directly: `STACKHERO_MINIO_HOST`, `STACKHERO_MINIO_ACCESS_KEY`, `STACKHERO_MINIO_SECRET_KEY` (host is normalized to `https://...` when no scheme is provided)
