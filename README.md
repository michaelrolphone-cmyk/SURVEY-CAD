...
- The LineSmith quick toolbar now includes grouped icon toggles for **Points**, **Names**, **Codes**, and **Notes**, plus a clustering toggle so users can disable clustering and/or hide point markers entirely to view only linework.
