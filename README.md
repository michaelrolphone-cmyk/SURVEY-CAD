...
- `loadUtilitiesByAddress(address, outSR?)` → `/api/utilities` (Idaho Power residential utility lookup normalized for RecordQuarry preview markers and PointForge export points, including `code` labels for service-line begin/end markers)
