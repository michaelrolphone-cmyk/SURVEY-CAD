...
- ArrowHead roll mapping now inverts raw `DeviceOrientationEvent` gamma/beta signs per screen orientation so physical right-tilt rotates overlays clockwise on-screen (matching handset motion instead of feeling inverted).
