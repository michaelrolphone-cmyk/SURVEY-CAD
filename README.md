...
- While websocket transport is unavailable, clients use a low-frequency REST fallback sync (`GET /api/localstorage-sync`, `POST /api/localstorage-sync`) so browser state converges without high-frequency polling.
