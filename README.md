...
- When an app is opened, the launcher header title/icon switch to that app and a leading chevron appears before the icon to reinforce that clicking either the chevron area or icon returns to launcher home.
